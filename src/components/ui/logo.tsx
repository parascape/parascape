...
export const Logo = () => {
  return (
    <motion.div
      className="relative font-bold text-2xl select-none"
      whileHover={{ scale: 1.05 }}
      transition={{ duration: 0.2 }}
    >
      <span className="block relative">
        <span className="absolute inset-0 bg-gradient-to-br from-emerald-300 via-emerald-400 to-emerald-600 bg-clip-text text-transparent transform rotate-[2deg] blur-[0.5px]">
          PARASCAPE
        </span>
